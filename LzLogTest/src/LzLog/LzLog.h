...
public:
	...
	Log& operator<< (const std::string& const s) {
		strLog.append(s);
		return *this;
	}
...
#define LzLogNull  Log(__FILE__, __LINE__, GetCurrentThreadId(), LzLog::s_logList, LzLogLevelNull, clock())
#define LzLogError Log(__FILE__, __LINE__, GetCurrentThreadId(), LzLog::s_logList, LzLogLevelError, clock())
#define LzLogFail  Log(__FILE__, __LINE__, GetCurrentThreadId(), LzLog::s_logList, LzLogLevelFail, clock())
#define LzLogInfo  Log(__FILE__, __LINE__, GetCurrentThreadId(), LzLog::s_logList, LzLogLevelInfo, clock())
#define LzLogDebug Log(__FILE__, __LINE__, GetCurrentThreadId(), LzLog::s_logList, LzLogLevelDebug, clock())
